...
- **Taxonomy (design-time vs runtime):** [A Taxonomy of Agent Architectures: ReAct to Recursive Language Models](https://mitchgordon.me/tools/2026/01/14/taxonomy-of-agent-architectures.html). Mitchell A. Gordon, 2026. ReAct to multi-agent static to dynamic routing to RLM.
