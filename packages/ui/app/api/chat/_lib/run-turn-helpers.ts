...
export function buildContinueShellApprovalMessage(data: { command: string; stdout?: string; stderr?: string; exitCode?: number }): string {
...
export function shouldSkipRephrase(
  content: string,
