...
export default function ChatFeedbackModal({
  ...
  return (
    <>
      <div className="chat-feedback-backdrop" role="presentation" onClick={onClose} />
      <div className="chat-feedback-drawer" role="dialog" aria-label="Conversation feedback">
        ...
        <div className="chat-feedback-drawer-body">
          {!hasConversation ? (
            <p style={{ fontSize: "0.9rem", color: "var(--text-muted)" }}>
              Start or select a conversation to rate it and add a note.
            </p>
          ) : (
            <>
              <div className="chat-rate-row" style={{ marginBottom: "1rem" }}>
                <span
                  className="chat-rate-label"
                  style={{
                    display: "block",
