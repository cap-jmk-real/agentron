    ...
    <div style={{ maxWidth: 560, margin: "0 auto", padding: "2rem 1rem" }}>
      <div style={{ textAlign: "center", marginBottom: "2rem" }}>
        <div style={{ marginBottom: "0.75rem" }}>
          <BrandIcon size={56} className="brand-logo" />
        </div>
        ...
        >
          <li style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Your vault stores API keys and passwords for the chat agent. Set a master password
                to create it.
              </p>
              <Link
                href="/settings/vault"
          ...
          <li style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
            <span
              style={{
                ...
                height: 28,
                borderRadius: "50%",
                background: status.hasLlmProvider ? "#22c55e" : "var(--surface-muted)",
                color: status.hasLlmProvider ? "white" : "var(--text-muted)",
                display: "inline-flex",
                alignItems: "center",
                justifyContent: "center",
                flexShrink: 0,
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Connect OpenAI, Anthropic, Ollama, or another provider so the chat assistant can
                respond.
              </p>
              <Link
                href="/settings/llm"
          ...
          <li style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                Run models locally with Ollama. Install and add as an LLM provider for private,
                offline use.
              </p>
              <Link
                href="/settings/local"
          ...
          <li style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              >
                For sandboxes and code execution, install Docker or Podman and choose the engine in
                settings.
              </p>
              <Link
