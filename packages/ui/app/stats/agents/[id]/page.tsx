            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
              {timeSeries.slice(-14).map((d) => (
                <div key={d.date} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                  ...
                  >
                    <div
                      className="agent-stats-bar-segment-in"
                      style={{ width: `${(d.promptTokens / maxDay) * 100}%` }}
                    />
                    <div
                      className="agent-stats-bar-segment-out"
                      style={{ width: `${(d.completionTokens / maxDay) * 100}%` }}
                    />
                  </div>
                  <span
                    style={{
        ...
        <div style={{ display: "grid", gap: "0.4rem" }}>
          {runs.map((r) => (
            <div
              key={r.id}
              className="card"
              style={{ padding: 0, fontSize: "0.8rem", overflow: "hidden" }}
            >
              <div
                style={{
              ...
              <details className="agent-stats-call-details">
                ...
                <div className="agent-stats-call-io">
                  ...
                  <div className="agent-stats-call-io-block agent-stats-call-output">
                    ...
                    <span className="agent-stats-call-io-value">
                      {fmt(r.completionTokens)} tokens
                    </span>
                  </div>
                </div>
              </details>
