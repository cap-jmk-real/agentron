    ...
    <div style={{ maxWidth: 800 }}>
      ...
      {agents.length === 0 ? (
        <p style={{ fontSize: "0.82rem", color: "var(--text-muted)" }}>
          No agent usage recorded in this workflow.
        </p>
      ) : (
              ...
              <div className="card" style={{ padding: "0.65rem 0.85rem", cursor: "pointer" }}>
                ...
                >
                  ...
                  <span style={{ fontSize: "0.75rem", color: "var(--text-muted)" }}>
                    {fmt(a.promptTokens + a.completionTokens)} tokens &middot;{" "}
                ...
                >
                  <div style={{ display: "flex", height: "100%" }}>
                    <div
                      style={{
                        width: `${(a.promptTokens / maxAgent) * 100}%`,
                    ...
                    <div
                      style={{
                        width: `${(a.completionTokens / maxAgent) * 100}%`,
